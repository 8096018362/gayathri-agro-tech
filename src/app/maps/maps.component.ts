...
export class MapsComponent implements OnInit {
    ...
    constructor(public router: Router, private fb: FormBuilder, private cdr: ChangeDetectorRef, public dataService: DashboardService) { }
    ...
    addPO() {
        if (this.form.valid) {
            ...
            newRecord = { ...data, totalWt, amount, totalAmount, balance };
